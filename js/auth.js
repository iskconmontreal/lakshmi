/* Lakshmi Boutique POS — Auth Module
   Token storage and OAuth capture, ported verbatim from sankirtan-pos.
   The logged-in cashier IS the writer: counter-sales are attributed server-side
   to the JWT user, so there is no shared write key.
*/
...
export const auth = {
  ...
  // Auth keys ONLY — never touches the pending queue or archive.
  clear() {
